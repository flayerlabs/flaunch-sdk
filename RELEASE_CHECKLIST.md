...
The site remains on published 0.12.0 until a separately reviewed consumer update. This 0.13.0 candidate includes the 0.12.1 launch fixes and release tooling. Protected swaps require compatible deployed and approved routers and explicit integration into the site's direct V2 swap path; an npm update alone is insufficient. Keep this release behind those capability and integration gates.
