// AnyPositionManager hook, v1.3.x generation (six-field FlaunchParams / PoolCreated with pairedToken). Adds flaunchWithLiquidity and the PoolScheduled event for AnyFlaunchZap launches. The legacy AnyPositionManagerAbi stays for the original AnyPositionManagerAddress generation.
// Generated from flaunch-contracts PR #289 (any-flaunch-vested-zap, commit 7b44600) out/AnyPositionManager.sol/AnyPositionManager.json. Base Sepolia vested generation 0xE753a351FB498051a09Dc130fcC29aEBc76525DC (2026-09-11).
export const AnyFlaunchZapPositionManagerAbi = [
  {
    type: "constructor",
    inputs: [
      {
        name: "params",
        type: "tuple",
        internalType: "struct IAnyPositionManager.ConstructorParams",
        components: [
          {
            name: "poolManager",
            type: "address",
          ...
          },
          {
            name: "feeExemptions",
            type: "address",
            internalType: "contract IFeeExemptions"
          },
          {
            name: "actionManager",
            type: "address",
          ...
          },
          {
            name: "bidWall",
            type: "address",
            internalType: "contract IBidWall"
          },
          {
            name: "internalSwapPool",
            type: "address",
            internalType: "contract IInternalSwapPool"
          },
          {
            name: "oracle",
            type: "address",
    ...
    inputs: [
      {
        name: "_params",
        type: "tuple",
        internalType: "struct IAnyPositionManager.FlaunchParams",
        components: [
          {
            name: "memecoin",
            type: "address",
    ...
    outputs: [
      {
        name: "",
        type: "address",
        internalType: "contract IAnyFlaunch"
      }
    ],
    stateMutability: "view"
  },
  {
    ...
    inputs: [
      ...
      {
        name: "_liquidityParams",
        type: "tuple",
        internalType: "struct IAnyPositionManager.LiquidityParams",
        components: [
          {
            name: "seedAmount",
            type: "uint256",
  ...
  {
    type: "function",
    name: "pairedTokenBidWallThreshold",
    inputs: [
      {
        name: "_poolId",
        type: "bytes32",
  ...
  {
    type: "error",
    name: "CallerIsNotApprovedCreator",
    inputs: []
  },
  {
    type: "error",
