// Flaunch v1.3.1 multi-asset ERC721OwnerFeeSplitManager (flaunch-managers release v1.3.1-base).
// Generated from flaunch-managers `out/ERC721OwnerFeeSplitManager.sol/ERC721OwnerFeeSplitManager.json` via scripts/abi-from-artifact.mjs.
export const ERC721OwnerFeeSplitManagerV1_3Abi = [
  {
    type: "constructor",
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "tuple",
        indexed: false,
        internalType: "struct IERC721OwnerFeeSplitManager.InitializeParams",
        components: [
          {
            name: "creatorShare",
            type: "uint256",
          ...
          },
          {
            name: "shares",
            type: "tuple[]",
            internalType: "struct IERC721OwnerFeeSplitManager.ERC721Share[]",
            components: [
              {
                name: "erc721",
                type: "address",
