// Flaunch v1.3.1 multi-asset DynamicAddressFeeSplitManager (flaunch-managers release v1.3.1-base).
// Generated from flaunch-managers `out/DynamicAddressFeeSplitManager.sol/DynamicAddressFeeSplitManager.json` via scripts/abi-from-artifact.mjs.
export const DynamicAddressFeeSplitManagerV1_3Abi = [
  {
    type: "constructor",
    inputs: [
      {
