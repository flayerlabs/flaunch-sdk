// Flaunch GameDeveloperFeeSplitManager: a v1.3.1 multi-asset DynamicAddressFeeSplitManager whose game developer holds a protected 5% slot.
// Generated from flaunch-managers `out/GameDeveloperFeeSplitManager.sol/GameDeveloperFeeSplitManager.json` via scripts/abi-from-artifact.mjs.
export const GameDeveloperFeeSplitManagerAbi = [
  {
    type: "constructor",
    inputs: [
      {
  ...
  {
    type: "function",
    name: "transferGameDeveloper",
    inputs: [
      {
        name: "_newGameDeveloper",
        type: "address",
        internalType: "address"
      }
    ],
  ...
  {
    type: "event",
    name: "GameDeveloperPayoutUpdated",
    inputs: [
      {
        name: "_oldPayout",
        type: "address",
  ...
  {
    type: "event",
    name: "GameDeveloperTransferred",
    inputs: [
      {
        name: "_oldGameDeveloper",
        type: "address",
        indexed: true,
        internalType: "address"
      },
  ...
  {
    type: "error",
    name: "CreatorAndOwnerSharesDisallowed",
    inputs: []
  },
  {
    type: "error",
  ...
  {
    type: "error",
    name: "InvalidGameDeveloper",
    inputs: []
  },
  {
    type: "error",
    name: "InvalidGameDeveloperPayout",
    inputs: []
  },
  {
    type: "error",
    name: "InvalidGameDeveloperShare",
    inputs: [
      {
        name: "_share",
        type: "uint256",
